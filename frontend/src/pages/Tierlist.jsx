    ...
    <div>
        ...
        <div className='flex flex-col items-center'>
            <div className='flex flex-col w-3/4'>
                ...
                <div className='flex'>
                    <div className='flex flex-col flex-shrink-0 w-1/3 bg-[#31313c] rounded-md px-2 h-[1000px] '>
                        <div className='h-[400px] bg-red-800'/>
                    </div>
                    <div className='flex flex-col flex-shrink-0 bg-[#31313c] grow ml-2 rounded-md h-[1000px]'>
